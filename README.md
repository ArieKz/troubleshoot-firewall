...
<img width="781" height="625" alt="Ping-linuxVm-from-windows- shell" src="https://github.com/user-attachments/assets/1daefc89-2f9e-401e-9a8e-8e3726c89edb" /><br />
 ___
...
<img width="1512" height="982" alt="Ping-Window-Vm-to Linux_Vm" src="https://github.com/user-attachments/assets/99c65f63-b220-4751-9454-04cf6ee7c4a9" />
 ___
Ending the Linux Virtual Machine connection with the command (exit) and closing, after documenting the steps to complete the Performing Activities on the Network Lab. I plan to return to this repository in a few months and make more sense of what transpired as I become more proficient with Network security and settings.
